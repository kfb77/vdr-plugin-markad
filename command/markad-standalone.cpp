...
#define MAX_AFTER_ASSUMED 335    // changed from 293 to 335
    ...
    while (!begin && lStart) {
        ...
        if (diffAssumed < -215) {  // later start mark can be start of first ad, changed from -211 to -215 (long ad before)
            ...
            if (soundStartBefore && (soundStartBefore->position != mark->position)) { // do not move to same frame
                ...
                case MT_MOVEDSTART:
                    ...
                    case MT_VPSSTART:
                        ...
                        if (blackBefore)              maxBefore = 138440;
                        else if (lengthBefore >= 440) maxBefore =  37859;   // prevent to get silence before preview
