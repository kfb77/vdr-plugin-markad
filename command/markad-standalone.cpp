        ...
        if (silenceStop) {
            ...
            if (silenceStart) {
                ...
                if (logoStop) {
                    ...
                    dsyslog("cMarkAdStandalone::HaveSilenceSeparator(): MT_LOGOSTOP (%5d) -> %6dms -> MT_SOUNDSTOP (%4d) -> %5dms -> MT_SOUNDSTART (%4d) -> %5dms -> MT_LOGOSTART (%4d)", logoStop->position, logoStopSilenceStart, silenceStart->position, silenceStartSilenceStop, silenceStop->position, silenceStopLogoStart, mark->position);
// valid example
...
// MT_LOGOSTOP (    3) -> 138160ms -> MT_SOUNDSTOP (3457) ->  1160ms -> MT_SOUNDSTART (3486) ->   560ms -> MT_LOGOSTART (3500)  -> Nickelodeon, logo start from pattern in separaor
                    if ((logoStopSilenceStart <= 325840) && (silenceStartSilenceStop >= 80) && (silenceStartSilenceStop < 1160) && (silenceStopLogoStart <= 2960)) {
            ...
            if (stopAfter) {  // move even to same position to prevent scene change for move again
                ...
                case MT_MOVEDSTOP:
                    ...
                    case MT_VPSSTOP:
                        ...
                        else if (lengthAfter >=   80) maxAfter =  20119;
            ...
            if (soundStopAfter && (soundStopAfter->position != mark->position)) {
                ...
                case MT_MOVEDSTOP:
                    ...
                    case MT_VPSSTOP:
                        ...
                        if      (lengthAfter >=  440) maxAfter = 335480;
