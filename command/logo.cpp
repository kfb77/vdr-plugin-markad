...
// set start point
    ...
    if (!retStatus && (iFrameCountAll < MAXREADFRAMES) && ((iFrameCountAll > MAXREADFRAMES / 2) || (iFrameCountValid > 700))) {  // reached end of recording before we got 1000 valid frames
