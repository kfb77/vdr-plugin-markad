...
cppcheck: 
	cppcheck --enable=all \
             ...
             --suppress=unusedFunction:plugin/markad.cpp \
             --suppress=unusedFunction:plugin/markad.h \
             --suppress=unusedFunction:plugin/status.cpp \
             -DLIBAVCODEC_VERSION_INT=3940198 \
             -DDEBUGMEM=1 \
             --error-exitcode=1 .
